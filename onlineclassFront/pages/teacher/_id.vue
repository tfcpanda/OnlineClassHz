...
export default {
  ...
  created() {
    ...
    this.getTeacherDetial();
    console.log(this.teacher);
    console.log("赋值初始"+this.teacher.name);
    console.log(this.teacher.avatar);
    console.log(this.teacher.intro);
    console.log(this.teacher.career);
  },
  ...
  methods: {
    getTeacherDetial() {
      teacherApi.getById(this.teacherId).then((response) => {
        ...
        console.log("赋值后的"+this.teacher.name);
